...
void server::make_request(connected_client *const origin, const std::string &content) {
...
void server::send_request(connected_client *const origin, const std::string &message) {
...
void server::nickname_request(connected_client *const origin, const std::string &nickname) {
...
void server::join_request(connected_client *const origin, const std::string &channel_name) {
...
void server::kick_request(connected_client *const origin, const std::string &nickname) {
...
void server::toggle_mute_request(connected_client *const origin, const std::string &nickname, bool muted) {
...
void server::whois_request(connected_client *const origin, const std::string &nickname) {
